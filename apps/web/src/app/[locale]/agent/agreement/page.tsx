  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="bg-surface rounded-2xl border border-[#E2E4EB] overflow-hidden mb-6">
        ...
        <div className="p-6 border-b border-[#E2E4EB]">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-6 h-6 rounded-full bg-brand flex items-center justify-center text-xs font-bold text-[#0F1117]">1</div>
            <h2 className="text-base font-bold">{t('section1Title')}</h2>
          </div>
          <div className="text-sm text-[#5E6278] space-y-2">
        ...
        <div className="p-6 border-b border-[#E2E4EB]">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-6 h-6 rounded-full bg-brand flex items-center justify-center text-xs font-bold text-[#0F1117]">2</div>
        ...
        <div className="p-6">
          <div className="flex items-center gap-2 mb-3">
            <div className="w-6 h-6 rounded-full bg-brand flex items-center justify-center text-xs font-bold text-[#0F1117]">3</div>
