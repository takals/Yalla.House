...
export function SendBriefButton({ listingId, agentIds, label, translations: tt }: SendBriefButtonProps) {
  ...
  async function handleSend() {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || tt.errorSendFailed)
      }
      ...
      setError(err instanceof Error ? err.message : tt.errorGeneric)
    } finally {
      setSending(false)
    }
  }
