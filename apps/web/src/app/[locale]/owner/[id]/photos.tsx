    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 border-2 border-dashed border-[#D8DBE5] hover:border-brand rounded-xl text-sm font-medium text-text-secondary hover:text-text-primary transition-colors disabled:opacity-50 w-full justify-center"
        >
          {uploading ? (
            <>
