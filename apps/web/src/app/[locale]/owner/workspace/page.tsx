...
export default async function WorkspacePage() {
  ...
  const labels = {
    ...
    guideStep1: t('guideStep1'),
    guideStep1Hint: t('guideStep1Hint'),
    guideStep2: t('guideStep2'),
    guideStep2Hint: t('guideStep2Hint'),
    guideStep3: t('guideStep3'),
    guideStep3Hint: t('guideStep3Hint'),
    guideStep4: t('guideStep4'),
    guideStep4Hint: t('guideStep4Hint'),
    guideStep5: t('guideStep5'),
    guideStep5Hint: t('guideStep5Hint'),
    guideStep6: t('guideStep6'),
    guideStep6Hint: t('guideStep6Hint'),
    guideStep7: t('guideStep7'),
    guideStep7Hint: t('guideStep7Hint'),
    guideMinimise: t('guideMinimise'),
    guideRestore: t('guideRestore'),
    guideComplete: t('guideComplete'),
    exampleTitle: t('exampleTitle'),
    exampleAddress: t('exampleAddress'),
    examplePostcode: t('examplePostcode'),
