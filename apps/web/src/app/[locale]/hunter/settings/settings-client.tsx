...
interface Props {
  ...
  labels: {
    ...
    profileSaved: string
    privacy: string
    pauseAllSharing: string
    pauseAllSharingDesc: string
    pause: string
  ...
  return (
    <div className="space-y-8">
        ...
        {consentLog.length > 0 && (
          <div>
            ...
            <div className="space-y-2">
              {consentLog.map(ev => {
                const eventLabel = {
                  brief_shared: labels.briefShared,
                  contact_shared: labels.contactShared,
                  data_paused: labels.dataPaused,
                  data_resumed: labels.dataResumed,
                  agent_disconnected: labels.agentDisconnected,
                  data_deleted: labels.dataDeleted,
      ...
      <div className="bg-red-50 border border-red-200 rounded-card p-6">
        <h3 className="font-semibold text-red-800 mb-2">{labels.dangerZone}</h3>
        <p className="text-sm text-red-700 mb-4">
          {labels.deleteAllDataDesc}
        </p>
        {deleteAllMsg && (
