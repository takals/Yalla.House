        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-[#E2E4EB] p-8">
            ...
            <div className="space-y-4 text-[#656565] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Verschlüsselung in der Übertragung</h3>
                <p>
          ...
          <div className="bg-white rounded-2xl border border-[#E2E4EB] p-8">
            ...
            <div className="space-y-4 text-[#656565] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Zugriffsrechteverwaltung</h3>
                <p>
                  Mitarbeiter haben Zugriff nur auf die Daten, die sie für ihre Aufgaben benötigen (Least Privilege Principle).
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Datenschutz-Schulungen</h3>
                <p>
                  Alle Mitarbeiter erhalten regelmäßige DSGVO- und Datensicherheitsschulung.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Auftragsverarbeitungsverträge (AVV)</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Datenschutz Impact Assessment (DPIA)</h3>
                <p>
                  Bei neuen Verarbeitungen führen wir eine DPIA durch, um Risiken zu bewerten und Maßnahmen festzulegen.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Datenaufbewahrungsrichtlinien</h3>
                <p>
