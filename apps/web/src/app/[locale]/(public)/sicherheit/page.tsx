      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white rounded-2xl border border-[#E2E4EB] p-8">
            ...
            <div className="space-y-4 text-[#656565] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Transport Layer (TLS 1.3)</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Datenbank-Verschlüsselung (AES-256)</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Passwort-Sicherheit</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Token & Session-Verwaltung</h3>
                <p>
          ...
          <div className="bg-white rounded-2xl border border-[#E2E4EB] p-8">
            ...
            <div className="space-y-4 text-[#656565] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Rollenbasierte Zugriffskontrolle (RBAC)</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Multi-Faktor-Authentifizierung (MFA)</h3>
                <p>
                  Admin-Konten erfordern <strong>Multi-Faktor-Authentifizierung</strong> für erhöhte Sicherheit.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Audit Logging</h3>
                <p>
                  Alle sensiblen Operationen (Datenabfragen, Adminänderungen, Löschungen) werden protokolliert für Nachverfolgbarkeit.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">IP-Whitelist für Admin-Panel</h3>
                <p>
          ...
          <div className="bg-white rounded-2xl border border-[#E2E4EB] p-8">
            ...
            <div className="space-y-4 text-[#656565] leading-relaxed">
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Penetrationstests</h3>
                <p>
                  Monatliche externe Penetrationstests durch spezialisierte Sicherheitsfirmen identifizieren Schwachstellen.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Dependency Audits</h3>
                <p>
              ...
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Code Reviews</h3>
                <p>
                  Alle Codeänderungen durchlaufen mindestens zwei Sicherheits-Code-Reviews vor dem Deployment.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Vulnerability Scanning</h3>
                <p>
                  Automated Vulnerability Scanning in der CI/CD-Pipeline erkennt bekannte CVEs.
                </p>
              </div>
              <div>
                <h3 className="font-bold text-[#0F1117] mb-2">Sicherheits-Updates</h3>
                <p>
