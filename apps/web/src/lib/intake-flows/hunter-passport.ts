...
export function getHunterPassportFlow(
  ...
  return [
    ...
    {
      id: 'target_areas',
      question: translations.q_target_areas || "Which areas of London interest you? Select as many as you'd like.",
      type: 'chips',
      options: [
        { value: 'east_london', label: translations.opt_east_london || 'East London' },
        { value: 'north_london', label: translations.opt_north_london || 'North London' },
        { value: 'south_east_london', label: translations.opt_south_east_london || 'South East London' },
        { value: 'zone_2', label: translations.opt_zone_2 || 'Zone 2' },
        { value: 'zone_3', label: translations.opt_zone_3 || 'Zone 3' },
        { value: 'west_london', label: translations.opt_west_london || 'West London' },
        { value: 'south_west_london', label: translations.opt_south_west_london || 'South West London' },
      ],
      validation: { required: true },
    },
    {
